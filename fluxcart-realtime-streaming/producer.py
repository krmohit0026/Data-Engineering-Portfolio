...
produce 50 --> buffer has 50 --> sent --> confirmed --> sent = 50

time 10s report prints
produced = 500 (we generated 500 in total)
sent = 450 (last 50 are still in flight at this exact moment)

0.02 seconds later -> last 50 are confirmed -?> sent 500
but report is already printed, so you the gap
'''
